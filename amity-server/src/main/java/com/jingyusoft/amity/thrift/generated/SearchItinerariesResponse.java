...
public class SearchItinerariesResponse implements org.apache.thrift.TBase<SearchItinerariesResponse, SearchItinerariesResponse._Fields>, java.io.Serializable, Cloneable, Comparable<SearchItinerariesResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SearchItinerariesResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new SearchItinerariesResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SearchItinerariesResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SearchItinerariesResponse.class, metaDataMap);
  }

  public SearchItinerariesResponse() {
  }
   ...
   */
  public SearchItinerariesResponse(SearchItinerariesResponse other) {
  ...
  public SearchItinerariesResponse deepCopy() {
    return new SearchItinerariesResponse(this);
  }
  ...
  public SearchItinerariesResponse setErrorCode(int errorCode) {
    this.errorCode = errorCode;
    setErrorCodeIsSet(true);
    return this;
  }
  ...
  public SearchItinerariesResponse setItineraries(List<ItineraryDto> itineraries) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SearchItinerariesResponse)
      return this.equals((SearchItinerariesResponse)that);
    return false;
  }

  public boolean equals(SearchItinerariesResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(SearchItinerariesResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SearchItinerariesResponse(");
    boolean first = true;
  ...
  private static class SearchItinerariesResponseStandardSchemeFactory implements SchemeFactory {
    public SearchItinerariesResponseStandardScheme getScheme() {
      return new SearchItinerariesResponseStandardScheme();
    }
  }

  private static class SearchItinerariesResponseStandardScheme extends StandardScheme<SearchItinerariesResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, SearchItinerariesResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.itineraries = new ArrayList<ItineraryDto>(_list8.size);
                ItineraryDto _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  _elem9 = new ItineraryDto();
                  _elem9.read(iprot);
                  struct.itineraries.add(_elem9);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SearchItinerariesResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.itineraries != null) {
        if (struct.isSetItineraries()) {
          oprot.writeFieldBegin(ITINERARIES_FIELD_DESC);
          {
            ...
            for (ItineraryDto _iter11 : struct.itineraries)
            {
              _iter11.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class SearchItinerariesResponseTupleSchemeFactory implements SchemeFactory {
    public SearchItinerariesResponseTupleScheme getScheme() {
      return new SearchItinerariesResponseTupleScheme();
    }
  }

  private static class SearchItinerariesResponseTupleScheme extends TupleScheme<SearchItinerariesResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SearchItinerariesResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetItineraries()) {
        {
          ...
          for (ItineraryDto _iter12 : struct.itineraries)
          {
            _iter12.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SearchItinerariesResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.itineraries = new ArrayList<ItineraryDto>(_list13.size);
          ItineraryDto _elem14;
          for (int _i15 = 0; _i15 < _list13.size; ++_i15)
          {
            _elem14 = new ItineraryDto();
            _elem14.read(iprot);
            struct.itineraries.add(_elem14);
          }
        }
        struct.setItinerariesIsSet(true);
      }
