...
public class HelperItinerary implements org.apache.thrift.TBase<HelperItinerary, HelperItinerary._Fields>, java.io.Serializable, Cloneable, Comparable<HelperItinerary> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("HelperItinerary");
  ...
  static {
    schemes.put(StandardScheme.class, new HelperItineraryStandardSchemeFactory());
    schemes.put(TupleScheme.class, new HelperItineraryTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(HelperItinerary.class, metaDataMap);
  }

  public HelperItinerary() {
  }
   ...
   */
  public HelperItinerary(HelperItinerary other) {
  ...
  public HelperItinerary deepCopy() {
    return new HelperItinerary(this);
  }
  ...
  public HelperItinerary setId(long id) {
    this.id = id;
    setIdIsSet(true);
    return this;
  }
  ...
  public HelperItinerary setUserId(long userId) {
    this.userId = userId;
    setUserIdIsSet(true);
    return this;
  }
  ...
  public HelperItinerary setFromLocationid(int fromLocationid) {
    this.fromLocationid = fromLocationid;
    setFromLocationidIsSet(true);
    return this;
  }
  ...
  public HelperItinerary setLatestPickupDate(String latestPickupDate) {
    this.latestPickupDate = latestPickupDate;
    return this;
  }
  ...
  public HelperItinerary setToLocationId(int toLocationId) {
    this.toLocationId = toLocationId;
    setToLocationIdIsSet(true);
    return this;
  }
  ...
  public HelperItinerary setLatestDeliveryDate(String latestDeliveryDate) {
    this.latestDeliveryDate = latestDeliveryDate;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof HelperItinerary)
      return this.equals((HelperItinerary)that);
    return false;
  }

  public boolean equals(HelperItinerary that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(HelperItinerary other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("HelperItinerary(");
    boolean first = true;
  ...
  private static class HelperItineraryStandardSchemeFactory implements SchemeFactory {
    public HelperItineraryStandardScheme getScheme() {
      return new HelperItineraryStandardScheme();
    }
  }

  private static class HelperItineraryStandardScheme extends StandardScheme<HelperItinerary> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, HelperItinerary struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HelperItinerary struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class HelperItineraryTupleSchemeFactory implements SchemeFactory {
    public HelperItineraryTupleScheme getScheme() {
      return new HelperItineraryTupleScheme();
    }
  }

  private static class HelperItineraryTupleScheme extends TupleScheme<HelperItinerary> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, HelperItinerary struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, HelperItinerary struct) throws org.apache.thrift.TException {
