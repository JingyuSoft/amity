...
public class GetNearestCityRequest implements org.apache.thrift.TBase<GetNearestCityRequest, GetNearestCityRequest._Fields>, java.io.Serializable, Cloneable, Comparable<GetNearestCityRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetNearestCityRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new GetNearestCityRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetNearestCityRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetNearestCityRequest.class, metaDataMap);
  }

  public GetNearestCityRequest() {
  }
   ...
   */
  public GetNearestCityRequest(GetNearestCityRequest other) {
    __isset_bitfield = other.__isset_bitfield;
    this.latitude = other.latitude;
    this.longitude = other.longitude;
  }

  public GetNearestCityRequest deepCopy() {
    return new GetNearestCityRequest(this);
  }
  ...
  public GetNearestCityRequest setLatitude(double latitude) {
    this.latitude = latitude;
    setLatitudeIsSet(true);
    return this;
  }
  ...
  public GetNearestCityRequest setLongitude(double longitude) {
    this.longitude = longitude;
    setLongitudeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetNearestCityRequest)
      return this.equals((GetNearestCityRequest)that);
    return false;
  }

  public boolean equals(GetNearestCityRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetNearestCityRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetNearestCityRequest(");
    boolean first = true;
  ...
  private static class GetNearestCityRequestStandardSchemeFactory implements SchemeFactory {
    public GetNearestCityRequestStandardScheme getScheme() {
      return new GetNearestCityRequestStandardScheme();
    }
  }

  private static class GetNearestCityRequestStandardScheme extends StandardScheme<GetNearestCityRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetNearestCityRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetNearestCityRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class GetNearestCityRequestTupleSchemeFactory implements SchemeFactory {
    public GetNearestCityRequestTupleScheme getScheme() {
      return new GetNearestCityRequestTupleScheme();
    }
  }

  private static class GetNearestCityRequestTupleScheme extends TupleScheme<GetNearestCityRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetNearestCityRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetNearestCityRequest struct) throws org.apache.thrift.TException {
