...
public class ListHelpRequestRequest implements org.apache.thrift.TBase<ListHelpRequestRequest, ListHelpRequestRequest._Fields>, java.io.Serializable, Cloneable, Comparable<ListHelpRequestRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ListHelpRequestRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new ListHelpRequestRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ListHelpRequestRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ListHelpRequestRequest.class, metaDataMap);
  }

  public ListHelpRequestRequest() {
  }
   ...
   */
  public ListHelpRequestRequest(ListHelpRequestRequest other) {
    __isset_bitfield = other.__isset_bitfield;
    this.amityUserId = other.amityUserId;
  }

  public ListHelpRequestRequest deepCopy() {
    return new ListHelpRequestRequest(this);
  }
  ...
  public ListHelpRequestRequest setAmityUserId(long amityUserId) {
    this.amityUserId = amityUserId;
    setAmityUserIdIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ListHelpRequestRequest)
      return this.equals((ListHelpRequestRequest)that);
    return false;
  }

  public boolean equals(ListHelpRequestRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ListHelpRequestRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ListHelpRequestRequest(");
    boolean first = true;
  ...
  private static class ListHelpRequestRequestStandardSchemeFactory implements SchemeFactory {
    public ListHelpRequestRequestStandardScheme getScheme() {
      return new ListHelpRequestRequestStandardScheme();
    }
  }

  private static class ListHelpRequestRequestStandardScheme extends StandardScheme<ListHelpRequestRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ListHelpRequestRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ListHelpRequestRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ListHelpRequestRequestTupleSchemeFactory implements SchemeFactory {
    public ListHelpRequestRequestTupleScheme getScheme() {
      return new ListHelpRequestRequestTupleScheme();
    }
  }

  private static class ListHelpRequestRequestTupleScheme extends TupleScheme<ListHelpRequestRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ListHelpRequestRequest struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      oprot.writeI64(struct.amityUserId);
    }

    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ListHelpRequestRequest struct) throws org.apache.thrift.TException {
