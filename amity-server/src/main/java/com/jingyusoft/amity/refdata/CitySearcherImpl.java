...
public class CitySearcherImpl implements CitySearcher, CitySearcherMXBean {

	private static final Logger LOGGER = LoggerFactory.getLogger(CitySearcherImpl.class);
