...
public class ListItinerariesRequest implements org.apache.thrift.TBase<ListItinerariesRequest, ListItinerariesRequest._Fields>, java.io.Serializable, Cloneable, Comparable<ListItinerariesRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ListItinerariesRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new ListItinerariesRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ListItinerariesRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ListItinerariesRequest.class, metaDataMap);
  }

  public ListItinerariesRequest() {
  }
   ...
   */
  public ListItinerariesRequest(ListItinerariesRequest other) {
    __isset_bitfield = other.__isset_bitfield;
    this.amityUserId = other.amityUserId;
  }

  public ListItinerariesRequest deepCopy() {
    return new ListItinerariesRequest(this);
  }
  ...
  public ListItinerariesRequest setAmityUserId(long amityUserId) {
    this.amityUserId = amityUserId;
    setAmityUserIdIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ListItinerariesRequest)
      return this.equals((ListItinerariesRequest)that);
    return false;
  }

  public boolean equals(ListItinerariesRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ListItinerariesRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ListItinerariesRequest(");
    boolean first = true;
  ...
  private static class ListItinerariesRequestStandardSchemeFactory implements SchemeFactory {
    public ListItinerariesRequestStandardScheme getScheme() {
      return new ListItinerariesRequestStandardScheme();
    }
  }

  private static class ListItinerariesRequestStandardScheme extends StandardScheme<ListItinerariesRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ListItinerariesRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ListItinerariesRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ListItinerariesRequestTupleSchemeFactory implements SchemeFactory {
    public ListItinerariesRequestTupleScheme getScheme() {
      return new ListItinerariesRequestTupleScheme();
    }
  }

  private static class ListItinerariesRequestTupleScheme extends TupleScheme<ListItinerariesRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ListItinerariesRequest struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      oprot.writeI64(struct.amityUserId);
    }

    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ListItinerariesRequest struct) throws org.apache.thrift.TException {
