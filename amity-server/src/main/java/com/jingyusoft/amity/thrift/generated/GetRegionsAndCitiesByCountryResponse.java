...
public class GetRegionsAndCitiesByCountryResponse implements org.apache.thrift.TBase<GetRegionsAndCitiesByCountryResponse, GetRegionsAndCitiesByCountryResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetRegionsAndCitiesByCountryResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetRegionsAndCitiesByCountryResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new GetRegionsAndCitiesByCountryResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetRegionsAndCitiesByCountryResponseTupleSchemeFactory());
  }

  public int errorCode; // required
  public List<RegionDto> regions; // optional
  public List<CityDto> cities; // optional
  ...
  private static final _Fields optionals[] = {_Fields.REGIONS,_Fields.CITIES};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetRegionsAndCitiesByCountryResponse.class, metaDataMap);
  }

  public GetRegionsAndCitiesByCountryResponse() {
  }
   ...
   */
  public GetRegionsAndCitiesByCountryResponse(GetRegionsAndCitiesByCountryResponse other) {
    ...
    if (other.isSetCities()) {
      List<CityDto> __this__cities = new ArrayList<CityDto>(other.cities.size());
      for (CityDto other_element : other.cities) {
        __this__cities.add(new CityDto(other_element));
      }
      this.cities = __this__cities;
    }
  }

  public GetRegionsAndCitiesByCountryResponse deepCopy() {
    return new GetRegionsAndCitiesByCountryResponse(this);
  }
  ...
  public GetRegionsAndCitiesByCountryResponse setErrorCode(int errorCode) {
    this.errorCode = errorCode;
    setErrorCodeIsSet(true);
    return this;
  }
  ...
  public GetRegionsAndCitiesByCountryResponse setRegions(List<RegionDto> regions) {
  ...
  public java.util.Iterator<CityDto> getCitiesIterator() {
    return (this.cities == null) ? null : this.cities.iterator();
  }

  public void addToCities(CityDto elem) {
    if (this.cities == null) {
  ...
  public GetRegionsAndCitiesByCountryResponse setCities(List<CityDto> cities) {
    this.cities = cities;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetRegionsAndCitiesByCountryResponse)
      return this.equals((GetRegionsAndCitiesByCountryResponse)that);
    return false;
  }

  public boolean equals(GetRegionsAndCitiesByCountryResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetRegionsAndCitiesByCountryResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetRegionsAndCitiesByCountryResponse(");
    boolean first = true;
  ...
  private static class GetRegionsAndCitiesByCountryResponseStandardSchemeFactory implements SchemeFactory {
    public GetRegionsAndCitiesByCountryResponseStandardScheme getScheme() {
      return new GetRegionsAndCitiesByCountryResponseStandardScheme();
    }
  }

  private static class GetRegionsAndCitiesByCountryResponseStandardScheme extends StandardScheme<GetRegionsAndCitiesByCountryResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetRegionsAndCitiesByCountryResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.regions = new ArrayList<RegionDto>(_list24.size);
                RegionDto _elem25;
                for (int _i26 = 0; _i26 < _list24.size; ++_i26)
                {
                  _elem25 = new RegionDto();
                  _elem25.read(iprot);
                  struct.regions.add(_elem25);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.cities = new ArrayList<CityDto>(_list27.size);
                CityDto _elem28;
                for (int _i29 = 0; _i29 < _list27.size; ++_i29)
                {
                  _elem28 = new CityDto();
                  _elem28.read(iprot);
                  struct.cities.add(_elem28);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetRegionsAndCitiesByCountryResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.regions != null) {
        if (struct.isSetRegions()) {
          oprot.writeFieldBegin(REGIONS_FIELD_DESC);
          {
            ...
            for (RegionDto _iter30 : struct.regions)
            {
              _iter30.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.cities != null) {
        if (struct.isSetCities()) {
          oprot.writeFieldBegin(CITIES_FIELD_DESC);
          {
            ...
            for (CityDto _iter31 : struct.cities)
            {
              _iter31.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class GetRegionsAndCitiesByCountryResponseTupleSchemeFactory implements SchemeFactory {
    public GetRegionsAndCitiesByCountryResponseTupleScheme getScheme() {
      return new GetRegionsAndCitiesByCountryResponseTupleScheme();
    }
  }

  private static class GetRegionsAndCitiesByCountryResponseTupleScheme extends TupleScheme<GetRegionsAndCitiesByCountryResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetRegionsAndCitiesByCountryResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetRegions()) {
        {
          ...
          for (RegionDto _iter32 : struct.regions)
          {
            _iter32.write(oprot);
          }
        }
      ...
      if (struct.isSetCities()) {
        {
          ...
          for (CityDto _iter33 : struct.cities)
          {
            _iter33.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetRegionsAndCitiesByCountryResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.regions = new ArrayList<RegionDto>(_list34.size);
          RegionDto _elem35;
          for (int _i36 = 0; _i36 < _list34.size; ++_i36)
          {
            _elem35 = new RegionDto();
            _elem35.read(iprot);
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.cities = new ArrayList<CityDto>(_list37.size);
          CityDto _elem38;
          for (int _i39 = 0; _i39 < _list37.size; ++_i39)
          {
            _elem38 = new CityDto();
            _elem38.read(iprot);
            struct.cities.add(_elem38);
          }
        }
        struct.setCitiesIsSet(true);
      }
