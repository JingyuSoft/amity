...
public class GetNeaerestCityRequest implements org.apache.thrift.TBase<GetNeaerestCityRequest, GetNeaerestCityRequest._Fields>, java.io.Serializable, Cloneable, Comparable<GetNeaerestCityRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetNeaerestCityRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new GetNeaerestCityRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetNeaerestCityRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetNeaerestCityRequest.class, metaDataMap);
  }

  public GetNeaerestCityRequest() {
  }
   ...
   */
  public GetNeaerestCityRequest(GetNeaerestCityRequest other) {
    __isset_bitfield = other.__isset_bitfield;
    this.latitude = other.latitude;
    this.longitude = other.longitude;
  }

  public GetNeaerestCityRequest deepCopy() {
    return new GetNeaerestCityRequest(this);
  }
  ...
  public GetNeaerestCityRequest setLatitude(double latitude) {
    this.latitude = latitude;
    setLatitudeIsSet(true);
    return this;
  }
  ...
  public GetNeaerestCityRequest setLongitude(double longitude) {
    this.longitude = longitude;
    setLongitudeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetNeaerestCityRequest)
      return this.equals((GetNeaerestCityRequest)that);
    return false;
  }

  public boolean equals(GetNeaerestCityRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetNeaerestCityRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetNeaerestCityRequest(");
    boolean first = true;
  ...
  private static class GetNeaerestCityRequestStandardSchemeFactory implements SchemeFactory {
    public GetNeaerestCityRequestStandardScheme getScheme() {
      return new GetNeaerestCityRequestStandardScheme();
    }
  }

  private static class GetNeaerestCityRequestStandardScheme extends StandardScheme<GetNeaerestCityRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetNeaerestCityRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetNeaerestCityRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class GetNeaerestCityRequestTupleSchemeFactory implements SchemeFactory {
    public GetNeaerestCityRequestTupleScheme getScheme() {
      return new GetNeaerestCityRequestTupleScheme();
    }
  }

  private static class GetNeaerestCityRequestTupleScheme extends TupleScheme<GetNeaerestCityRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetNeaerestCityRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetNeaerestCityRequest struct) throws org.apache.thrift.TException {
